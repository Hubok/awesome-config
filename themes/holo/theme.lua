...
theme.wallpaper                                 = os.getenv("HOME") .. "/.config/awesome/wall/linus_torvalds.png"
...
-- MEM
 ...
 local mem = lain.widget.mem({
     settings = function()
         widget:set_markup(markup.font(theme.font, " " .. string.format("%." .. 2 .. "f", mem_now.used/1024) .. "GB "))
     end
 })
 local membg = wibox.container.background(mem.widget, theme.bg_focus, gears.shape.
  rectangle)
...
function theme.at_screen_connect(s)
    ...
    local tagNames = { " 1) Home", " 2) Social", " 3) Game", " 4) Code", " 5) E-Mail", " 6) ", " 7) ", " 8) Work ", " 9) Horizon"  }
    local l = awful.layout.suit
    local tagLayouts = { l.fair, l.fair, l.floating, l.fair, l.fair, l.fair, l.fair, l.fair, l.fair }
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            spr_right,
            spotify_widget({
                play_icon = '/usr/share/icons/Papirus-Light/24x24/apps/Spotify.svg',
                pause_icon = '/usr/share/icons/Papirus-Dark/24x24/apps/Spotify.svg',
